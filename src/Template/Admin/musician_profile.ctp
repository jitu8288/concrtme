		...
		<div class="panel panel-profile">
			<div class="clearfix">
						...
						<div class="profile-stat">
							<div class="row">
								<div class="col-md-4 stat-item">
									45 <span>Compaigns</span>
								</div>
								<div class="col-md-4 stat-item">
									15 <span>Success</span>
								</div>
								<div class="col-md-4 stat-item">
									2174 <span>Earn</span>
								</div>
				...
				<div class="profile-right">
					<h4 class="heading">Samuel's overview</h4>
					<!-- AWARDS -->
					<div class="awards">
						<div class="row">
					...
					<div class="custom-tabs-line tabs-line-bottom left-aligned">
						<ul class="nav" role="tablist">
							...
							<li><a href="#tab-bottom-left2" role="tab" data-toggle="tab">Compaigns <span class="badge">7</span></a></li>
						</ul>
					</div>
